        ...
        <main className="mt-20">
            ...
            <div className='flex flex-wrap w-full gap-8'>
                {coffees.map((coffee, index) => (
                    <div key={index} className='relative w-1/5 p-2 h-80 mx-5 bg-gray-100 border rounded-[6px_36px_6px_36px]'>
                        <img
                            src={coffee.image}
                            alt={coffee.name}
                        ...
                        <div className='flex items-center mt-12'>
                            <p className='text-gray-400 mx-6 text-sm'>R$
                                <span className="text-center ml-1 font-extrabold text-gray-500 text-2xl">{coffee.price.toFixed(2)}</span>
                            </p>
                            <Button
                                index={index}
